...
<xsl:transform version="1.1"
  ...
  <xsl:template match="/">
    <Ontology xmlns="http://www.w3.org/2002/07/owl#"
      xml:base="http://www.semanticweb.org/mercure-galant/ontologie/place"
      xmlns:rdfs="http://www.w3.org/2000/01/rdf-schema#"
      xmlns:xsd="http://www.w3.org/2001/XMLSchema#"
      xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
      xmlns:xml="http://www.w3.org/XML/1998/namespace"
      ontologyIRI="http://www.semanticweb.org/mercure-galant/ontologie/place">
  ...
  <xsl:template match="th:entree">
    ...
    <!-- si pas de parent, la lieu est fille de Place -->
  ...
  <xsl:template match="th:formeRejetee">
    ...
    <!-- déclaration de la propriété #is_rejected_place_form_of -->
    <ObjectPropertyAssertion>
      <ObjectProperty>
        <xsl:attribute name="IRI"><xsl:text>#is_rejected_place_form_of</xsl:text></xsl:attribute>
      </ObjectProperty>
      <NamedIndividual>
        <xsl:attribute name="IRI">
          <xsl:text>#</xsl:text>
    ...
    <!-- déclaration de la propriété #is_authority_place_form_of -->
    <ObjectPropertyAssertion>
      <ObjectProperty>
        <xsl:attribute name="IRI"><xsl:text>#is_authority_place_form_of</xsl:text></xsl:attribute>
      </ObjectProperty>
      <NamedIndividual>
        <xsl:attribute name="IRI">
          <xsl:text>#</xsl:text>
