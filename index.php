...
$teipotHref=$pot->baseHref.'../teipot/';
...
<html>
  <head>
    <meta charset="UTF-8" />
    <?php echo $doc['head']; ?>
    <link rel="stylesheet" type="text/css" href="<?php echo $teipotHref; ?>html.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo $teipotHref; ?>teipot.css" />
  </head>
  <body>
    <header id="header">
      <h1>
        <a href="<?php echo $pot->baseHref; ?>">Mercure-galant, prototype</a>
      </h1>
    ...
    <div id="center">
      <nav id="toolbar">
        <?php 
        echo '<a href="',$pot->baseHref,'">Mercure galant</a> » ';
...
?>
    ...
    <script type="text/javascript" src="<?php echo $teipotHref; ?>Tree.js">//</script>
    <script type="text/javascript" src="<?php echo $teipotHref; ?>Sortable.js">//</script>
